...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Edited     SahLaz
    Name       OSIF 'Open Source Information Facebook' - Edited
    CodeName   D3b2y
    Coder      Debby Anggraini 'CiKu370'
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   dump_sahlaz        fetching all id and email from your friends / edited
...
def sahlaz():
	...
	try:
		...
		out = open('output/' + n[0].split(' ')[0] + '_sahlaz.txt','w')
